<template>
    <div class="container">
        <h1><mark>[7.2] Flip Cards para Catalógos II</mark></h1>
        <p><a href="https://bbbootstrap.com/snippets/bootstrap-5-simple-card-hover-effects-50607616" target="_blank" rel="noopener">Fuente: Bootstrap 5 Simple card hover effects</a></p>
